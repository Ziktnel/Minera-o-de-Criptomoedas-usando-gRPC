...
def mine_loop(stub, client_id="1", max_attempts=200000):
    # pega desafio atual
    info = stub.GetCurrentChallenge(grpcCalc_pb2.Empty())
    ...
    while attempts < max_attempts:
        ...
        sub = grpcCalc_pb2.SolutionSubmission(
            transaction_id=tx,
...
if __name__ == "__main__":
    ...
    stub = grpcCalc_pb2_grpc.MinerStub(channel)
